...
void gapuino8_flash_partition_init(pi_device_t *flash_dev)
{
    ...
    hal_partitions[HAL_PARTITION_BOOTLOADER].aos_partition.partition_length      = 0x80000; /* 512k bytes -- 256KB sectors*/
    ...
    hal_partitions[HAL_PARTITION_BOOTLOADER].sector_size                        = 0x40000;
    ...
    //hal_partitions[HAL_PARTITION_PARAMETER_2].aos_partition.partition_start_addr  = 0x03FF8000;
    hal_partitions[HAL_PARTITION_PARAMETER_2].aos_partition.partition_start_addr  = 0x04000000;
    ...
    hal_partitions[HAL_PARTITION_SPIFFS].aos_partition.partition_start_addr     = 0x00080000;
    hal_partitions[HAL_PARTITION_SPIFFS].aos_partition.partition_length         = 0x00F00000; /* 15M bytes -- 256KB sectors*/
    ...
    hal_partitions[HAL_PARTITION_SPIFFS].sector_size                       = 0x40000;
}
