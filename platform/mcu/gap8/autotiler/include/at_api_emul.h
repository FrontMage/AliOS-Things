...
#define AT_HYPERRAM_COPY2D(dev,ext,loc,size,stride,length,dir,event) \
do { \
...
typedef int AT_HYPERFLASH_FS_EVENT;
...
#define AT_HYPERFLASH_FS_COPY(file,ext,loc,size,dir,event) \
