...

{
    ...
    switch (FilterConf) {
        case 0: // [0..4 x 0] => [2..4 x 0]
            C0 = *((v4s*) (Filter + 0*5+2)); C0[3] = 0;
            break;
        case 1: // [0..4 x 0] => [1..4 x 0]
            C0 = *((v4s*) (Filter + 0*5+1));
            break;
        case 2: // [0..4 x 0] => [0..3 x 0]
            C0 = *((v4s*) (Filter + 0*5+0));
            break;
        case 3: // [0..4 x 0] => [0..2 x 0]
    ...
    )
{
    ...
    x0 = *(PtIn+0*W+0); x1 = *(PtIn+1*W+0); x2 = *(PtIn+2*W+0); x3 = *(PtIn+3*W+0); V0 = (v4s) gap8_pack4(x0,x1,x2,x3); PtIn++;
    ...
    )
{
        ...
        switch (FilterConf) { 
        case 0: // [0..4 x 0] => [2..4 x 0]
            C0 = *((v2s*) (Filter + 0*5+2)); C1 = (v2s) gap8_pack2(Filter[0*5+4], 0);
            break;
        case 1: // [0..4 x 0] => [1..4 x 0]
        ...
        case 2: // [0..4 x 0] => [0..3 x 0]
            ...
            break;
        case 3: // [0..4 x 0] => [0..2 x 0]
            C0 = (v2s) gap8_pack2(0, Filter[0*5+0]); C1 = *((v2s*) (Filter + 0*5+1));
            break;
    }
        PtIn = In + (Ho_F*1-PadOrg[2])*W; PtOut = Out+Ho_F*Wo;
        V0 = * (v2s *) PtIn; PtIn += W;
...

{
    ...
    switch (FilterConf) {
        case 0: // [0 x 0..4] => [0 x 2..4]
            C0 = *((v2s*) (Filter + 0*5+2)); C1 = (v2s) gap8_pack2(Filter[0*5+4], 0);
            break;
        case 1: // [0 x 0..4] => [0 x 1..4]
            C0 = *((v2s*) (Filter + 0*5+1)); C1 = *((v2s*) (Filter + 0*5+3));
            break;
        case 2: // [0 x 0..4] => [0 x 1..4]
            C0 = *((v2s*) (Filter + 0*5+0)); C1 = *((v2s*) (Filter + 0*5+2));
            break;
        case 3: // [0 x 0..4] => [0 x 2..4]
            C0 = (v2s) gap8_pack2(0, Filter[0*5+0]); C1 = *((v2s*) (Filter + 0*5+1));
            break;
    }
        x0 = *(PtIn+0*W+0); x1 = *(PtIn+1*W+0); x2 = *(PtIn+2*W+0); x3 = *(PtIn+3*W+0); 
        V0 = (v2s) gap8_pack2(x0,x1); V1 = (v2s) gap8_pack2(x2,x3); 
        PtIn++;
        for (int i=Wo_F; i<Wo_L; i++) {
                int Acc = *PtOut<<Norm;
                Acc = gap8_sumdotp2(V0, C0, Acc); Acc = gap8_sumdotp2(V1, C1, Acc);
