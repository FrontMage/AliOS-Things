...
uint8_t g_enter_qpi_mode[] = {0,0,0,0};
...
int single_lanes_test()
{
    ...
    pi_spi_flags_e flag =  PI_SPI_LINES_SINGLE | PI_SPI_CS_AUTO;
#if 0
    g_buf[0] = 0x66;
    ...
    flag =  PI_SPI_LINES_SINGLE | PI_SPI_CS_AUTO;
    // Erase block 0
...
int qpi_flash_test(void)
{
    ...
    flag =  PI_SPI_LINES_QUAD | PI_SPI_CS_AUTO;
    // Erase block 0
    
    g_buf[0] = QSPIF_WR_EN_CMD;
    pi_spi_transfer(&qspi_dev0, (void*)g_buf, (void*)&g_buf[4],8, PI_SPI_LINES_QUAD | PI_SPI_CS_AUTO);
    ...
    *(uint32_t*)(&g_buf[4]) = SPI_CMD_DUMMY(DUMMY_CYCLES);
    ...
    pi_spi_receive_with_ucode(&qspi_dev0, (void*)data_r, 256*8,
            PI_SPI_LINES_QUAD | PI_SPI_CS_AUTO, 1, 8, g_buf);
